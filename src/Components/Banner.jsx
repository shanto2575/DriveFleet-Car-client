...
export default function HeroSection() {
    return (
        <section className="min-h-[80vh] flex items-center bg-linear-to-r from-gray-700 via-gray-950 to-gray-700 text-white lg:px-6">
            <div className="w-10/12 mx-auto flex flex-col md:flex-row items-center gap-10">
                <div className="flex-1 text-center justify-center md:text-left">
                    <h1 className="text-4xl md:text-6xl font-bold leading-tight 
                        bg-linear-to-r from-orange-500 via-purple-500 to-pink-500 
                        bg-clip-text text-transparent 
                        animate__animated animate__bounceInDown animate__delay-0.3s">
                        Drive Your <br />
                        Dream Car
                    </h1>
                    ...
                    <div className="mt-6 flex justify-center lg:justify-start ">
                        <Link
                            href="/explore-cars"
                            className="inline-block bg-cyan-500 hover:bg-cyan-600 text-2xl px-6 py-3 rounded-xl font-semibold transition "
                        >
                            Explore Cars
                        </Link>
                    </div>
